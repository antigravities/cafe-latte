/**
 * Steam login page module.
 * Wires up all UI for the Steam login flow: saved-account banner, manual login
 * form, and SteamGuard challenge. Calls navigateTo('page-connect') on success.
 *
